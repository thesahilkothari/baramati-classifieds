...
import AdPromotionPayment from "../../components/AdPromotionPayment";
      ...
      <section className="mx-auto max-w-4xl">
        <div className="rounded-3xl border bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-4 text-slate-600">
            Your ad has been received and is pending admin approval. Once
            approved, it will become visible on My Classifieds.
          </p>
        ...
        {adId ? (
          <AdPromotionPayment adId={adId} />
        ) : (
          <div className="mt-8 rounded-3xl border bg-white p-6 text-center text-slate-600">
            Promotion option is unavailable because ad reference is missing.
          </div>
        )}
      </section>
    </main>
