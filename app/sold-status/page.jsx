      ...
      <section className="mx-auto max-w-4xl">
        <div className="mb-8 rounded-3xl border-2 border-slate-900 bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-700">
            ...
            through My Classifieds, sold elsewhere, or still available. If still
            available, you can renew or upgrade your ad instantly.
          </p>
        </div>

        <SoldStatusForm initialAdId={adId} initialMobile={mobile} />
      </section>
    </main>
  );
}
